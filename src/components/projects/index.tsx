      ...
      <div className={styles.projects}>
        <div className={styles.project}>
          ...
          <div className={styles.desc}>
            Chamb é um e-commerce fictício desenvolvido para simular um ambiente
            real de vendas online, com arquitetura modular e código limpo
            seguindo princípios SOLID. O projeto prioriza escalabilidade, boas
            práticas de desenvolvimento e uma experiência completa (do catálogo
            ao checkout), servindo como base para estudos ou adaptação em
            cenários comerciais.
          </div>
          ...
          <a
            href="https://github.com/nnitiV/OnlineStore_Chamb"
        ...
        <div className={styles.project}>
          ...
          <div className={styles.desc}>
            Esta é uma landing page com o intuito de estar divulgado a marca da
            clínica Odontológica chamada Gran Viana, com intuito de impulsionar
            os lucros do site com design moderno e responsivo, priorizando a
            conversão e fidelização de novos clientes para a mesma, apresentando
            a clínica, seus tratamentos, ambiente, e uma breve introdução sobre
          ...
          <a
            href="https://odontogranvianna.com/"
            style={{ textDecoration: "none", color: "white" }}
            target="_blank"
          >
            <div className={styles.link}>
        ...
        <div className={styles.project}>
          ...
          <div className={styles.desc}>
            Este é um clone full-stack do Instagram desenvolvido para aplicar
            conceitos avançados de arquitetura de software. A aplicação conta
            com autenticação segura de usuários (JWT), sistema de postagens, e
            um feed dinâmico. O frontend foi construído com Next.js para alta
            performance, enquanto o backend utiliza C# (.NET Core) estruturado
            em Clean Architecture, integrado a um banco de dados relacional
            PostgreSQL.
          </div>
          <div className={styles.tecnologies}>
            <p>Tecnologias:</p>
          ...
          <a
            href="https://instagram-clone-ui-livid.vercel.app"
            style={{ textDecoration: "none", color: "white" }}
            target="_blank"
